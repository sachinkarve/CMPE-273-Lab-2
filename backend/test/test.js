...
// // //2
    ...
    //         agent.post("/login")
    //             .send({ email_id: "mocha@sjsu.edu", password: "pasord" })
    //             .then(function (res) {
    //                 expect(res.status).to.equal(401);
    //             })
    //             .catch(error => {
...
//                 .send({ name: "moccha_Owner", res_name: "Restaurant", res_cuisine: "Cuisine", email_id: "mocha@sjsu.edu", password: "password", res_zip_code: "23342", address:"San Jose", phone_number: "980765551"})
//                 .then(function (res) {
//                     console.log(res);
//                     expect(res.status).to.equal(200);
//                 })
